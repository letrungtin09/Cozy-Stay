...
export default class ApiJoinConvenient {
  ...
  public getArrayConvenient = async (
    req: NextApiRequest,
    res: NextApiResponse
  ) => {
    try {
      ...
      const resultPlaces = await JoinConvenient.fetchJoinConvenientbyIdplaces(
        ids
      );
  ...
  public postaddJoinConvenient = async (
    ...
    try {
      ...
      const idConvenient = req.body.idConvenient;
      const data = {
        idPlace: idPlace,
        idConvenient: idConvenient,
      };
