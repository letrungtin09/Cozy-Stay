...
import DetailShowAllImage from "../detailPlace/imageDetail/detailShowAllImg";
import DetailPartner from "../detailPlace/partNerDetail";
import DetailImage from "../detailPlace/imageDetail/detailImg";
import HandleComment from "./handleComment";
import DetailMapMyPlace from "./detailMapMyPlace";
import DetailInforMyPlace from "./inforTableDetailMyPlace";
            ...
            <LayoutCustomer>
                ...
                <div className="detailContent flex justify-center">
                    <div className="w-[1120px]">
                        ...
                        <div className="detailInfo flex">
                            <HandleComment idPlace={id} />
                        </div>

                        <div className="detailInfo__line"></div>

                        <DetailMapMyPlace dataPlace={dataPlace} />
