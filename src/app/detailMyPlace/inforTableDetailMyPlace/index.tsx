...
import TableInforMyPlace from "./tableDetailMyPlace";

const DetailInforMyPlace: React.FC = ({ dataPlace, dataJoinConvenient, dataConvenient, dataParner }: any) => {
    ...
    return (
        <section className="detailInfo">
            <div className="row">
                ...
                <div className="col-5">
                    {checkForLease && <TableInforMyPlace bill={billData} />}
                </div>
            </div>
        </section>
    );
}
export default DetailInforMyPlace;