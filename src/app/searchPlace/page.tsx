...
export default function Home() {
  ...
  const apiPlaces = `${localUrl}/api/places?keyword=${keyword}`;
      ...
      <LayoutCustomer>
        <section className="SearchResults-container section-padding">
          <h1 className="title-SearchResults">
            Kết quả tìm kiếm của <span id="kq-search">{`"${keyword}"`}</span>
          </h1>
          <p className="sub-title-SearchResults pt-[5px] pb-[15px]">
            {" "}
            Có <span id="sl-search">{dataCount}</span> chỗ ở phù hợp{" "}
          </p>
