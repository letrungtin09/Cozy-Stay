...
export const RenderPlaces = ({ cateId }: any) => {
  ...
  return (
    <div className="places">
                  ...
                  <div className="places__slider">
                    <div className="places__list w-full">
                      <div className="places__img img1 h-full">
                        <CarouselRenderPlaces imageAr={imageArray} onChangeData={handleDataChange} />
                      </div>
                    </div>
                  </div>
                  <Link
      ...
      {isOverlayVisible && <CarouselShowFullImg onChangeOverLAy={changeOverLAy} dataLishImg={dataAllImgShow} indexImg={indexImgShow} />}
    </div>
  );
};
